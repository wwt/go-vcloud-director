...
func (client *Client) APIVCDMaxVersionIs(ctx context.Context, versionConstraint string) bool {
	err := client.vcdFetchSupportedVersions(ctx)
	if err != nil {
...
func (client *Client) vcdFetchSupportedVersions(ctx context.Context) error {
...
// MaxSupportedVersion parses the supported version list and returns the highest version in string format.
...
func (client *Client) validateAPIVersion(ctx context.Context) error {
	err := client.vcdFetchSupportedVersions(ctx)
	if err != nil {
...
func (client *Client) GetVcdVersion(ctx context.Context) (string, time.Time, error) {

	path := client.VCDHREF
	path.Path += "/admin"
	var admin types.VCloud
	_, err := client.ExecuteRequest(ctx, path.String(), http.MethodGet,
...
func (client *Client) GetVcdShortVersion(ctx context.Context) (string, error) {

	vcdVersion, err := client.GetVcdFullVersion(ctx)
	if err != nil {
...
func (client *Client) GetVcdFullVersion(ctx context.Context) (VcdVersion, error) {
	var vcdVersion VcdVersion
	version, versionTime, err := client.GetVcdVersion(ctx)
	if err != nil {
...
func (client *Client) VersionEqualOrGreater(ctx context.Context, compareTo string, howManyDigits int) (bool, error) {

	fullVersion, err := client.GetVcdFullVersion(ctx)
	if err != nil {
		return false, err
	}
