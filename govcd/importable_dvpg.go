...
//
// Note. API returns only unused DVPGs. If the DVPG is already consumed - it will not be returned.
func (vcdClient *VCDClient) GetVcenterImportableDvpgByName(ctx context.Context, name string) (*VcenterImportableDvpg, error) {
	if name == "" {
		return nil, fmt.Errorf("empty importable Distributed Virtual Port Group Name specified")
	}

	vcImportableDvpgs, err := vcdClient.GetAllVcenterImportableDvpgs(ctx, nil)
	if err != nil {
...
//
// Note. API returns only unused DVPGs. If the DVPG is already consumed - it will not be returned.
func (vcdClient *VCDClient) GetAllVcenterImportableDvpgs(ctx context.Context, queryParameters url.Values) ([]*VcenterImportableDvpg, error) {
	return getAllVcenterImportableDvpgs(ctx, &vcdClient.Client, queryParameters)
}

// GetVcenterImportableDvpgByName retrieves a DVPG that is available for import within the Org VDC.
func (vdc *Vdc) GetVcenterImportableDvpgByName(ctx context.Context, name string) (*VcenterImportableDvpg, error) {
	if name == "" {
		return nil, fmt.Errorf("empty importable Distributed Virtual Port Group Name specified")
	}

	vcImportableDvpgs, err := vdc.GetAllVcenterImportableDvpgs(ctx, nil)
	if err != nil {
...
//
// Note. API returns only unused DVPGs. If the DVPG is already consumed - it will not be returned.
func (vdc *Vdc) GetAllVcenterImportableDvpgs(ctx context.Context, queryParameters url.Values) ([]*VcenterImportableDvpg, error) {
	...
	return getAllVcenterImportableDvpgs(ctx, vdc.client, queryParams)

}

func getAllVcenterImportableDvpgs(ctx context.Context, client *Client, queryParameters url.Values) ([]*VcenterImportableDvpg, error) {
