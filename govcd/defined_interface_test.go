...
func (vcd *TestVCD) Test_DefinedInterface(check *C) {
	...
	allDefinedInterfacesBySysAdmin, err := systemAdministratorClient.GetAllDefinedInterfaces(ctx, nil)
	check.Assert(err, IsNil)
	alreadyPresentRDEs := len(allDefinedInterfacesBySysAdmin)

	allDefinedInterfacesByTenant, err := tenantUserClient.GetAllDefinedInterfaces(ctx, nil)
	check.Assert(err, IsNil)
	...
	newDefinedInterfaceFromSysAdmin, err := systemAdministratorClient.CreateDefinedInterface(ctx, dummyRde)
	check.Assert(err, IsNil)
	...
	// nss and name as API is quirky at versions of VCD <= 10.3.0
	nilDefinedInterface, err := tenantUserClient.CreateDefinedInterface(ctx, &types.DefinedInterface{
	...
	obtainedDefinedInterface, err := systemAdministratorClient.GetDefinedInterfaceById(ctx, newDefinedInterfaceFromSysAdmin.DefinedInterface.ID)
	check.Assert(err, IsNil)
	check.Assert(*obtainedDefinedInterface.DefinedInterface, DeepEquals, *newDefinedInterfaceFromSysAdmin.DefinedInterface)

	obtainedDefinedInterface, err = tenantUserClient.GetDefinedInterfaceById(ctx, newDefinedInterfaceFromSysAdmin.DefinedInterface.ID)
	check.Assert(err, IsNil)
	check.Assert(*obtainedDefinedInterface.DefinedInterface, DeepEquals, *newDefinedInterfaceFromSysAdmin.DefinedInterface)

	obtainedDefinedInterface2, err := systemAdministratorClient.GetDefinedInterface(ctx, obtainedDefinedInterface.DefinedInterface.Vendor, obtainedDefinedInterface.DefinedInterface.Nss, obtainedDefinedInterface.DefinedInterface.Version)
	check.Assert(err, IsNil)
	check.Assert(*obtainedDefinedInterface2.DefinedInterface, DeepEquals, *obtainedDefinedInterface.DefinedInterface)

	obtainedDefinedInterface2, err = tenantUserClient.GetDefinedInterface(ctx, obtainedDefinedInterface.DefinedInterface.Vendor, obtainedDefinedInterface.DefinedInterface.Nss, obtainedDefinedInterface.DefinedInterface.Version)
	check.Assert(err, IsNil)
	check.Assert(*obtainedDefinedInterface2.DefinedInterface, DeepEquals, *obtainedDefinedInterface.DefinedInterface)

	// Update the Defined Interface as System administrator
	err = newDefinedInterfaceFromSysAdmin.Update(ctx, types.DefinedInterface{
	...
	err = obtainedDefinedInterface2.Update(ctx, types.DefinedInterface{
	...
	_, err = systemAdministratorClient.GetDefinedInterfaceById(ctx, deletedId)
	check.Assert(err, NotNil)
