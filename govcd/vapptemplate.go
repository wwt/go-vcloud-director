...
func (vAppTemplate *VAppTemplate) GetCatalogName(ctx context.Context) (string, error) {
	queriedVappTemplates, err := queryVappTemplateListWithFilter(ctx, vAppTemplate.client, map[string]string{
...
func (vAppTemplate *VAppTemplate) GetVdcName(ctx context.Context) (string, error) {
	queriedVappTemplates, err := queryVappTemplateListWithFilter(ctx, vAppTemplate.client, map[string]string{
		"id": vAppTemplate.VAppTemplate.ID,
	})
	if err != nil {
...
func (vAppTemplate *VAppTemplate) GetVappTemplateRecord(ctx context.Context) (*types.QueryResultVappTemplateType, error) {
	queriedVappTemplates, err := queryVappTemplateListWithFilter(ctx, vAppTemplate.client, map[string]string{
		"id": vAppTemplate.VAppTemplate.ID,
	})
	if err != nil {
...
func (vAppTemplate *VAppTemplate) Update(ctx context.Context) (*VAppTemplate, error) {
	if vAppTemplate.VAppTemplate == nil {
	...
	task, err := vAppTemplate.UpdateAsync(ctx)
	if err != nil {
		return nil, err
	}
	err = task.WaitTaskCompletion(ctx)
...
func (vAppTemplate *VAppTemplate) UpdateAsync(ctx context.Context) (Task, error) {
	...
	return vAppTemplate.client.ExecuteTaskRequest(ctx, url, http.MethodPut,
...
func (vAppTemplate *VAppTemplate) DeleteAsync(ctx context.Context) (Task, error) {
	...
	return vAppTemplate.client.ExecuteTaskRequest(ctx, vappTemplateHref.String(), http.MethodDelete,
...
func (vAppTemplate *VAppTemplate) Delete(ctx context.Context) error {
	task, err := vAppTemplate.DeleteAsync(ctx)
	if err != nil {
		return err
	}
	err = task.WaitTaskCompletion(ctx)
...
func (vcdClient *VCDClient) GetVAppTemplateByHref(ctx context.Context, href string) (*VAppTemplate, error) {
	return getVAppTemplateByHref(ctx, &vcdClient.Client, href)
}
...
// On failure, returns a nil pointer and an error.
func (vcdClient *VCDClient) GetVAppTemplateById(ctx context.Context, vAppTemplateId string) (*VAppTemplate, error) {
	return getVAppTemplateById(ctx, &vcdClient.Client, vAppTemplateId)
}
...
// found.
func (vcdClient *VCDClient) QuerySynchronizedVAppTemplateById(ctx context.Context, vAppTemplateId string) (*types.QueryResultVappTemplateType, error) {
...
// Returns types.QueryResultVMRecordType if it is found, returns ErrorEntityNotFound if not found, or an error if many are
// found.
func (vcdClient *VCDClient) QueryVmInVAppTemplateByHref(ctx context.Context, vAppTemplateHref, vmNameInTemplate string) (*types.QueryResultVMRecordType, error) {
...
func (vcdClient *VCDClient) QuerySynchronizedVmInVAppTemplateByHref(ctx context.Context, vAppTemplateHref, vmNameInTemplate string) (*types.QueryResultVMRecordType, error) {
	vmRecord, err := vcdClient.QueryVmInVAppTemplateByHref(ctx, vAppTemplateHref, vmNameInTemplate)
	if err != nil {
		return nil, err
	}
