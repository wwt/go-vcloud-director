...
func (orgVdcNet *OpenApiOrgVdcNetwork) GetOpenApiOrgVdcNetworkDhcp(ctx context.Context) (*OpenApiOrgVdcNetworkDhcp, error) {
	...
	err = client.OpenApiGetItem(ctx, apiVersion, urlRef, nil, orgNetDhcp.OpenApiOrgVdcNetworkDhcp, nil)
	if err != nil {
		return nil, err
	}
...
func (vdc *Vdc) GetOpenApiOrgVdcNetworkDhcp(ctx context.Context, orgNetworkId string) (*OpenApiOrgVdcNetworkDhcp, error) {
	...
	err = client.OpenApiGetItem(ctx, apiVersion, urlRef, queryParameters, orgNetDhcp.OpenApiOrgVdcNetworkDhcp, nil)
	if err != nil {
		return nil, err
	}
...
func (vdc *Vdc) UpdateOpenApiOrgVdcNetworkDhcp(ctx context.Context, orgNetworkId string, orgVdcNetworkDhcpConfig *types.OpenApiOrgVdcNetworkDhcp) (*OpenApiOrgVdcNetworkDhcp, error) {
	return updateOrgNetworkDhcp(ctx, vdc.client, orgNetworkId, orgVdcNetworkDhcpConfig)
}
...
func (vdc *Vdc) DeleteOpenApiOrgVdcNetworkDhcp(ctx context.Context, orgNetworkId string) error {
	endpoint := types.OpenApiPathVersion1_0_0 + types.OpenApiEndpointOrgVdcNetworksDhcp
	apiVersion, err := vdc.client.getOpenApiHighestElevatedVersion(ctx, endpoint)
	if err != nil {
		return err
	}
	...
	err = vdc.client.OpenApiDeleteItem(ctx, apiVersion, urlRef, nil, nil)
	if err != nil {
...
func (orgVdcNet *OpenApiOrgVdcNetwork) DeletNetworkDhcp(ctx context.Context) error {
	endpoint := types.OpenApiPathVersion1_0_0 + types.OpenApiEndpointOrgVdcNetworksDhcp
	apiVersion, err := orgVdcNet.client.getOpenApiHighestElevatedVersion(ctx, endpoint)
	if err != nil {
		return err
	}
	...
	err = orgVdcNet.client.OpenApiDeleteItem(ctx, apiVersion, urlRef, nil, nil)
...
func updateOrgNetworkDhcp(ctx context.Context, client *Client, orgNetworkId string, orgVdcNetworkDhcpConfig *types.OpenApiOrgVdcNetworkDhcp) (*OpenApiOrgVdcNetworkDhcp, error) {
	endpoint := types.OpenApiPathVersion1_0_0 + types.OpenApiEndpointOrgVdcNetworksDhcp
	apiVersion, err := client.getOpenApiHighestElevatedVersion(ctx, endpoint)
	if err != nil {
		return nil, err
	...
	err = client.OpenApiPutItem(ctx, apiVersion, urlRef, nil, orgVdcNetworkDhcpConfig, orgNetDhcpResponse.OpenApiOrgVdcNetworkDhcp, nil)
	if err != nil {
